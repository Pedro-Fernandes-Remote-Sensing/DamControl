...
```{r, eval=FALSE}
RGBSum_YearX_IndividualZOI_ListOfLists = IndividualProduct(RGBSum_YearX_ZOI, ZOI_Shapefile_List, ExportPath_RGBSum_Individual_YearX, ID_list, "RGBSum_YearX_ZOI_", "Singular RGBSum Exported ", "Completed RGBSum ", "Completed All RGBSum")
```
...
```{r, eval=FALSE}
ExportRasterList(RGBSum_YearX_ZOI_Binary, ExportPath_RGBSum_Binary_All_, "RGBSum_Binary_All_YearX_", "Finished Exporting Binary RGBSum ", "Finished Exporting all Binary RGBSum")
```
...
```{r, eval=FALSE}
Binary_RGBSum_YearX_IndividualZOI_ListOfLists = IndividualProduct(RGBSum_YearX_ZOI_Binary, ZOI_Shapefile_List, ExportPath_RGBSum_Binary_Individual_, ID_list, "RGBSum_Binary_YearX_ZOI_", "Singular Binary RGBSum Exported ", "Completed Binary RGBSum ", "Completed All Binary RGBSum")
```
...
```{r, eval=FALSE}
ExportRasterList(Algorithm_YearX_ZOI_Binary, ExportPath_Algorithm_All_, "Algorithm_Binary_All_YearX_", "Finished Exporting Binary Algorithm ", "Finished Exporting all Binary Algorithm")
```
...
```{r, eval=FALSE}
Binary_Algorithm_YearX_IndividualZOI_ListOfLists = IndividualProduct(Algorithm_YearX_ZOI_Binary, ZOI_Shapefile_List, ExportPath_Algorithm_Individual_, ID_list, "Algorithm_Binary_YearX_ZOI_", "Singular Binary Algorithm Exported ", "Completed Binary Algorithm ", "Completed All Binary Algorithm")
```
