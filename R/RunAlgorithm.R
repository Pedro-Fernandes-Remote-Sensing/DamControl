...
RunAlgorithm = function(Year_List, ShapefilePath, ShapefileName, Output_Path, NDVI_Threshold, RGBSum_Threshold){
  ...
  for (Year in Year_List) {
    ...
    NameHolder = paste0("NDVIListYear", Year)
    ...
    ExportRasterList(NDVI_YearX_ZOI, get(NameHolder), "NDVI_All_YearX_", "Finished Exporting NDVI ", "Finished Exporting all NDVI")
    ...
    NDVI_YearX_IndividualZOI_ListOfLists = IndividualZOIProduct(NDVI_YearX_ZOI, ZOI_Shapefile_List, get(NameHolder), ID_list, "NDVI_YearX_ZOI_", "Singular NDVI Exported ", "Completed ZOI ", "Completed All ZOI")
    ...
    ExportRasterList(NDVI_YearX_ZOI_Binary, get(NameHolder), "Binary_NDVI_All_YearX_", "Finished Exporting Binary NDVI ", "Finished Exporting all Binary NDVI")
    ...
    NDVI_Binary_YearX_IndividualZOI_ListofLists = IndividualZOIProduct2(NDVI_YearX_ZOI_Binary, ZOI_Shapefile_List, get(NameHolder), ID_list, NDVI_Threshold[[1]], "Binary_NDVI_YearX_ZOI_", "Singular Binary NDVI Exported ", "Completed ZOI ", "Completed All ZOI")
    # 23 - Build Composite Bricks
    NameHolder = paste0("CompositeListYear", Year)
    ...
    ExportRasterList(Composite_YearX_ZOI, get(NameHolder), "Composite_All_YearX_", "Finished Exporting Composite ", "Finished Exporting all Composites")
    ...
    Composite_YearX_IndividualZOI_ListOfLists = IndividualZOIProduct(Composite_YearX_ZOI, ZOI_Shapefile_List, get(NameHolder), ID_list, "Composite_YearX_ZOI_", "Singular Composite Exported ", "Completed ZOI ", "Completed All ZOI")
    ...
    ExportRasterList(RGBSum_YearX_ZOI, get(NameHolder), "RGBSum_All_YearX_", "Finished Exporting RGBSum ", "Finished Exporting all RGBSum")
    ...
    RGBSum_YearX_IndividualZOI_ListOfLists = IndividualZOIProduct(RGBSum_YearX_ZOI, ZOI_Shapefile_List, get(NameHolder), ID_list, "RGBSum_YearX_ZOI_", "Singular RGBSum Exported ", "Completed RGBSum ", "Completed All RGBSum")
    ...
    ExportRasterList(RGBSum_YearX_ZOI_Binary, get(NameHolder), "RGBSum_Binary_All_YearX_", "Finished Exporting Binary RGBSum ", "Finished Exporting all Binary RGBSum")
    ...
    Binary_RGBSum_YearX_IndividualZOI_ListOfLists = IndividualZOIProduct(RGBSum_YearX_ZOI_Binary, ZOI_Shapefile_List, get(NameHolder), ID_list, "RGBSum_Binary_YearX_ZOI_", "Singular Binary RGBSum Exported ", "Completed Binary RGBSum ", "Completed All Binary RGBSum")
    ...
    ExportRasterList(Algorithm_YearX_ZOI_Binary, get(NameHolder), "Algorithm_Binary_All_YearX_", "Finished Exporting Binary Algorithm ", "Finished Exporting all Binary Algorithm")
    ...
    Binary_Algorithm_YearX_IndividualZOI_ListOfLists = IndividualZOIProduct(Algorithm_YearX_ZOI_Binary, ZOI_Shapefile_List, get(NameHolder), ID_list, "Algorithm_Binary_YearX_ZOI_", "Singular Binary Algorithm Exported ", "Completed Binary Algorithm ", "Completed All Binary Algorithm")
    # 41 - Organize your Algorithm Data into lists;
    ...
    # 41 - [OPTIONAL] Organize your BinaryNDVI Data into lists;
    ...
    Algorithm_ZOI_Dataframe_List_YearX = GenerateCSV2(Binary_Algorithm_YearX_IndividualZOI_ListOfLists, get(NameHolder), "Agricultural Year X", ID_list, "Algorithm", NDVI_Threshold[[1]], RGBSum_Threshold[[1]])
    # 43 - [OPTIONAL] Generate and export some .csv for further use. This will also return a Dataframe
    NameHolder = paste0("ExportPath_CSV_", Year)
    BinaryNDVI_ZOI_Dataframe_List_YearX =  GenerateCSV(NDVI_Binary_YearX_IndividualZOI_ListofLists, get(NameHolder), "Agricultural Year X", ID_list, "BinaryNDVI", NDVI_Threshold[[1]])
